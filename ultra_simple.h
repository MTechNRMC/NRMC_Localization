...
int on_finished(RPlidarDriver ** drv)
{
...
int ultra_simple(int argc, const char * argv[], RPlidarDriver ** drv) {
	...
	*/
	...
	quality = (nodes[pos].sync_quality & RPLIDAR_RESP_MEASUREMENT_SYNCBIT) ?"S ":"  ",
